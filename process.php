...
if(!$_POST) exit;
       ...
       if (isset($_POST['verify'])) :
        ...
        if($error == '') {
         ...
         $e_subject = 'Wafer.TCQP.Science contact from ' . $name . '.';
         ...
         // Configuration option.
                 ...
                 $e_body = "We have been contacted by $name through the Wafer.TCQP.Science contact form." . PHP_EOL . PHP_EOL;
         ...
         $headers = "From: TCQP.Science <noreply@tcqp.science>" . PHP_EOL;
